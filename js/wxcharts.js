...
function drawPointShape(t, e, i, a) {
  a.beginPath(), a.setStrokeStyle("rgba(0,0,0,0)"), a.setLineWidth(1), a.setFillStyle(e), "diamond" === i ? t.forEach(function (t, e) {
...
function drawLineDataPoints(t, e, i, a) {
  ...
  t.forEach(function (t, o) {
    ...
    if (a.beginPath(), a.setStrokeStyle(t.color), a.setLineWidth(1.5), a.moveTo(s[0].x, s[0].y), s.forEach(function (t, e) {
...
function drawXAxis(t, e, i, a) {
  ...
  //最底部横线（刻度尺颜色）
  a.beginPath(), a.setStrokeStyle("rgba(0,0,0,0)"), a.setLineWidth(1), a.moveTo(r, h), a.lineTo(s, h), e.xAxis.disableGrid !== !0 && o.forEach(function (t, e) {
