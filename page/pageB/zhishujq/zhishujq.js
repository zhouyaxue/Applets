Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'https://m.weatherol.com.cn/getIndexsTypeData?type=' + options.type + '&id=' + options.id,
      method: 'get',
      dataType: 'json',
      success: function (res) {
        ...
        wx.request({
          ...
          success: function (res) {
            ...
            that.setData({
              hiddenLoading: true,
              wendu: res.data.current.temperature,
              tianqi: res.data.current.weather,
              fengji: res.data.current.windPowerDecoder,
            })
  ...
  onShareAppMessage: function () {
    ...
    var path = '/page/pageB/zhishujq/zhishujq?id=' + cityid + '&type=' + type;
    return {
      title: "点击查看景区指数详情",
      path: path,
      success: function (res) {
